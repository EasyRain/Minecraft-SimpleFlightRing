...
- **八枚遗迹戒指（只能捡到损坏版）**：幽匿 / 矿工 / 绿宝石 / 海洋 / 荒漠 / 劫掠 / 炼狱 / 末影飞行戒指，
  **均无法合成**——损坏版分别以 **每箱 2%**（**矿工戒指 4%**）的概率出现在远古城市 / 废弃矿井（箱子矿车）/
  沉船 / 沙漠神殿 / 掠夺者哨塔·林地府邸 / 下界要塞 / 末地城的箱子里（绿宝石戒指改由
  **大师级图书管理员**出售，且只有 **50%** 概率刷出该交易），
  在工作台把损坏戒指与对应主题材料**无序合成**即可修复（幽匿 / 矿工 / 绿宝石 / 海洋另有任务链）。
  另新增按键 **V**（占位、可改键），用于触发特殊戒指的主动能力。
