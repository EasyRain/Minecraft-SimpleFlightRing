...
public final class ApothicAttributesCompat {
    ...
    private static final Identifier DODGE_CHANCE =
            Identifier.fromNamespaceAndPath("apothic_attributes", "dodge_chance");
    ...
    public static Holder<Attribute> dodgeChance() {
        if (!resolved) {
            resolved = true;
            dodgeAttribute = BuiltInRegistries.ATTRIBUTE.get(DODGE_CHANCE).orElse(null);
        }
