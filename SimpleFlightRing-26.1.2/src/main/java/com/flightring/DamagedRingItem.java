...
public class DamagedRingItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display,
        ...
        if (relic == RelicRing.RAID) {
            ...
            tooltipComponents.accept(Component.translatable("tooltip.simpleflightring.raid_damaged_lost")
                    .withStyle(ChatFormatting.GRAY));
            tooltipComponents.accept(Component.translatable("tooltip.simpleflightring.raid_damaged_will")
                    .withStyle(ChatFormatting.GRAY));
        ...
        if (relic == RelicRing.ENDER) {
            ...
            tooltipComponents.accept(Component.translatable("tooltip.simpleflightring.ender_damaged_dormant")
                    .withStyle(ChatFormatting.GRAY));
            if (charged) {
                tooltipComponents.accept(Component.translatable("tooltip.simpleflightring.ender_damaged_forge")
                        .withColor(RingAbility.WARP_NEXUS.color()));
            } else {
                tooltipComponents.accept(Component.translatable("tooltip.simpleflightring.ender_damaged_dormant2")
                        .withStyle(ChatFormatting.GRAY));
                tooltipComponents.accept(Component.translatable("tooltip.simpleflightring.ender_damaged_wake")
                        .withColor(RingAbility.WARP_NEXUS.color()));
            }
            return;
        }
        if (relic == RelicRing.INFERNAL) {
            ...
            tooltipComponents.accept(Component.translatable(awake
