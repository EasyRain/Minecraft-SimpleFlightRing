...
public class DamagedRingItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display,
        ...
        if (relic == RelicRing.INFERNAL) {
            ...
            tooltipComponents.accept(Component.translatable("tooltip.simpleflightring.infernal_damaged_asleep")
                    .withStyle(ChatFormatting.GRAY));
            tooltipComponents.accept(Component.translatable(isWitherCharged(stack)
            ...
            tooltipComponents.accept(Component.translatable("tooltip.simpleflightring.infernal_damaged_lava")
                    .withStyle(ChatFormatting.GRAY));
            return;
        }
