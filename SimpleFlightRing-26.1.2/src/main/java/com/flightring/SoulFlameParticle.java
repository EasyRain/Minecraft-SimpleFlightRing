 ...
 * <p>
 * 26.1.2 note: the old {@code TextureSheetParticle} is called {@code SingleQuadParticle} here and
 * its constructor wants the sprite up front, so the first sprite of the set is passed in.
 * <p>
